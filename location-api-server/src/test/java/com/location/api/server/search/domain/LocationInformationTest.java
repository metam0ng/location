...
import com.location.api.server.search.domain.Address;
import com.location.api.server.search.domain.Coordinate;
import com.location.api.server.search.domain.Location;
